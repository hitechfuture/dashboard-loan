				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Plano (meses)</label>
							...
							<div class="form-group">
								<label class="control-label">Multa Mensal Vencida</label>
								<div class="input-group">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 <p>Anos/mês: <b><?php echo $months ?></b></p>
										 <p><small>Interesse: <b><?php echo $row['interest_percentage']."%" ?></b></small></p>
										 <p><small>Multa Vencida: <b><?php echo $row['penalty_rate']."%" ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_plan" type="button" data-id="<?php echo $row['id'] ?>" data-months="<?php echo $row['months'] ?>" data-interest_percentage="<?php echo $row['interest_percentage'] ?>" >Editar</button>
										<button class="btn btn-sm btn-danger delete_plan" type="button" data-id="<?php echo $row['id'] ?>">Deletar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_plan').click(function(){
		_conf("Tem certeza de que deseja excluir este plano?","delete_plan",[$(this).attr('data-id')])
	})
