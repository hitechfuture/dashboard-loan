		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					...
					<button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button" id="new_payments"><i class="fa fa-plus"></i>Novo Pagamento</button>
				</large>
				...
				<table class="table table-bordered" id="loan-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">Nº de referência do empréstimo</th>
