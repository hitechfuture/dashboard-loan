		...
		<div class="row">
			...
			<form action="" id="manage-loan-type">
				<div class="card">
					...
					Formulário de Tipo de Empréstimo
				  	</div>
					<div class="card-body">
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Tipo de empréstimo</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 <p>Digite o nome: <b><?php echo $row['type_name'] ?></b></p>
										 <p><small>Descrição: <b><?php echo $row['description'] ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_ltype" type="button" data-id="<?php echo $row['id'] ?>" data-type_name="<?php echo $row['type_name'] ?>" data-description="<?php echo $row['description'] ?>" >Editar</button>
										<button class="btn btn-sm btn-danger delete_ltype" type="button" data-id="<?php echo $row['id'] ?>">Deletar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_ltype').click(function(){
		_conf("Tem certeza de que deseja excluir este tipo de empréstimo?","delete_ltype",[$(this).attr('data-id')])
	})
